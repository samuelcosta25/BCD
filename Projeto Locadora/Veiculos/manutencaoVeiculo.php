            ...
            <div class="card-body">
                <form method="GET" class="row mb-4">
                    <div class="col-md-4">
                        ...
                        <input type="text" id="placa" name="placa" class="form-control" placeholder="Digite o placa do carro">
                    </div>
                    <div class="col-md-3">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        $count_query = "SELECT COUNT(*) AS total FROM Manutencao
                                        JOIN Carro ON Manutencao.placa = Carro.placa";
                        ...
                        $query = "SELECT Manutencao.id_manutencao, Manutencao.descricao, Manutencao.data_manutencao, Manutencao.custo, Carro.Modelo AS carro
                                  FROM Manutencao
                                  JOIN Carro ON Manutencao.placa = Carro.placa";
                        if (count($conditions) > 0) {
